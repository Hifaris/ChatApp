                    ...
                    <div className="flex items-center justify-center w-full">
                        <Tabs className="w-3/4">
                            ...
                            <TabsContent className="flex flex-col gap-5 mt-10" value="login">
                                ...
                                <Button className="rounded-full p-6" onClick={hdlLogin}>Login</Button>
                            </TabsContent>

                            <TabsContent className="flex flex-col gap-5" value="signup">
                                <Input placeholder="Email" type="email" className="rounded-full p-6" value={email} onChange={(e) => setEmail(e.target.value)} />
                                <Input placeholder="Password" type="password" className="rounded-full p-6" value={password} onChange={(e) => setPassword(e.target.value)} />
                                <Input placeholder="ConfirmPassword" type="email" className="rounded-full p-6" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
                                <Button className="rounded-full p-6" onClick={hdlSingUp}>Sigup</Button>
                            </TabsContent>
                        </Tabs>
                    </div>
                </div>
